...
#             note_value = clampToNewRange(
#                 note["note"], 0, 127, 0, len(self.pixels[0]))

#             note_left = note_value - \
#                 note["time_since_apparation"] // 2 * note["velocity"] // 10
...
#                 self.pixels,
#                 note_left,
#                 color_scheme[note["color"]][0] - 50 -
#                 note["time_since_apparation"] * 3,
#                 color_scheme[note["color"]][1] - 50 -
#                 note["time_since_apparation"] * 3,
#                 color_scheme[note["color"]][2] - 50 -
#                 note["time_since_apparation"] * 3,
#                 value
#             )
