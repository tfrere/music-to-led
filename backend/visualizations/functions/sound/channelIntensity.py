...
class ChannelIntensity():
    ...
    def initChannelIntensity(self):
        ...
        self.intervalForDecrease = self.timeSinceStart.getMsIntervalFromBpm(
            self.active_state.time_interval)
        self.intervalForMaxDecrease = self.timeSinceStart.getMsIntervalFromBpm(
    ...
    def visualizeChannelIntensity(self):
        ...
        chunk_size = len(
            self.audio_data) // self.pixelReshaper.number_of_strips
