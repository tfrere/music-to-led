...
class FullColor():
    ...
    def visualizeFullColor(self):
        ...
        self.pixels[1] = self.lerp(
            self.pixels[1], color_scheme[0][1], self.old_full_intensity)
        self.pixels[2] = self.lerp(
            self.pixels[2], color_scheme[0][2], self.old_full_intensity)
